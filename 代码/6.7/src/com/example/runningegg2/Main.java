...
{	
	...
	//	final String nameC = bundle.getString("name");
	    ...
	    TextViewmap.setOnClickListener(new Button.OnClickListener(){
			 public void onClick(View v){
				 ...
				 intent.setClass(Main.this , map1.class );	
        ...
        addorder = (ImageView)findViewById(R.id.check);
		 ...
		 mContactTextView.setOnClickListener(new Button.OnClickListener(){
			 public void onClick(View v){
				 Intent intent = new Intent();
				 intent.setClass(Main.this , Main3.class );
				 startActivity(intent); 
				 finish();				 
			 }
		 }
		 ...
		 Spinner spinner = (Spinner)findViewById(R.id.spinner);
	        ...
	        data_list.add("三餐");
	        data_list.add("小吃城");
	        ArrayAdapter<String> arr_adapter= new ArrayAdapter<String>(Main.this, android.R.layout.simple_spinner_item, data_list);
	        //设置样式
		...
		MySimpleAdapter myAdapter = new MySimpleAdapter(Main.this.getApplicationContext(),listItems,
				R.layout.a1,
		...
		MySimpleAdapter myAdapter1 = new MySimpleAdapter(Main.this.getApplicationContext(),listItems1,
				R.layout.a1,
				new String[] {"tv_name","tv_desc","tv_addr","pic","price"},
		        new int[] {R.id.tv_name,R.id.tv_desc,R.id.tv_addr,R.id.pic,R.id.tv_price}   );
		...
		MySimpleAdapter myAdapter2 = new MySimpleAdapter(Main.this.getApplicationContext(),listItems2,
				R.layout.a1,
				new String[] {"tv_name","tv_desc","tv_addr","pic","price"},
		        new int[] {R.id.tv_name,R.id.tv_desc,R.id.tv_addr,R.id.pic,R.id.tv_price}   );
	...
	public class MyThread implements Runnable {
		...
		public void run() {
				...
				if (true) {
					MySimpleAdapter myAdapter2 = new MySimpleAdapter(Main.this,net,
							R.layout.a1,
